        ...
        //check email validity
            ...
            Auth.auth().createUser(withEmail: email, password: password) { authResult, error in
                if error != nil {
                    ...
                    let perilViewController = storyBoard.instantiateViewController(withIdentifier: "tabarController") as! UITabBarController
                    self.navigationController?.pushViewController(perilViewController, animated: true)
                }
            }
        }
    }
